package com.example.newswatchtower5.newyorknews
...
class NewYorkNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        loadData(view.context, recyclerView, getString(R.string.america), null)

        swipeRefreshLayout.setOnRefreshListener {
            loadData(view.context, recyclerView, getString(R.string.america), swipeRefreshLayout)
        }
